...
-}
module DayEighteen.PartOne(Out, solution, Vertex(..), parseVertex, neighbors) where
...
-- | Parse a vertex from a line of input.
...
-- | Get all non-diagonal neighbors of a vertex.
